...
function setCookie(obj){
    if(obj.hasOwnProperty('email') && obj.hasOwnProperty('firstname') && obj.hasOwnProperty('lastname') && obj.hasOwnProperty("username")){
        ...
        $.cookie('username', obj.username, { expires: 1, path: '/' });
